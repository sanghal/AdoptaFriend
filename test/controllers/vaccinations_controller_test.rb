...
class VaccinationsControllerTest < ActionController::TestCase
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post :create, vaccination: { animal_id: @vaccination.animal_id, date: @vaccination.date, name: @vaccination.name }
    end
  ...
  test "should update vaccination" do
    patch :update, id: @vaccination, vaccination: { animal_id: @vaccination.animal_id, date: @vaccination.date, name: @vaccination.name }
    assert_redirected_to vaccination_path(assigns(:vaccination))
  end
